...
# La carpeta de documentacion se renderiza desde su propia raiz, por lo que
# la base de datos vive un nivel arriba en el proyecto principal.
data_path <- file.path("..", "output", "data", "data-060125.RData")
if (!file.exists(data_path)) {
  stop("No se encontró el archivo de datos: ", data_path)
}
load(file = data_path)
